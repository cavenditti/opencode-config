...
try {
  ...
  assert.equal(asks.length, 2, "initial and redirected private URLs must each be authorized")
  ...
  console.log("PASS webfetch plugin redirect, rendering, permission, and hard-deny integration")
} finally {
  controller.abort()
